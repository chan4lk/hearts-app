...
import { BsCalendarEvent, BsPeople, BsCheckCircle, BsXCircle } from 'react-icons/bs';
...
export default function EventStatsSection({ events }: EventStatsSectionProps) {
  const statsList = [
    {
      title: 'Total Events',
      value: events.total,
