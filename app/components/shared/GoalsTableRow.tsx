        ...
        {onDueDateChange && (!canEditDateFn || canEditDateFn(goal)) ? (
          <div className="relative">
            <input
              ...
              className="bg-surface-secondary border border-white/10 text-primary text-2xs px-2 py-1 pr-6 rounded-md hover:bg-surface-secondary/50 transition-colors cursor-pointer focus-ring/50 focus:border-[rgb(var(--color-warning))]/50 disabled:opacity-50 disabled:cursor-not-allowed"
            />
