...
export function StandardCard({ children, className = '', hover = true }: StandardCardProps) {
  return (
    <motion.div
      ...
      className={`relative bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl rounded-xl p-6 border border-gray-700/50 shadow-lg overflow-hidden ${className}`}
    >
