  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative w-full max-w-md rounded-xl border border-white/10 bg-gradient-to-b from-gray-900 to-gray-800 p-6 shadow-2xl backdrop-blur-xl"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 rounded-lg border border-white/10 py-2 font-semibold text-white hover:bg-white/10 transition"
                >
                  Cancel
                </button>
              </div>
