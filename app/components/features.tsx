...
const features = [
  {
    ...
    accent: 'from-[rgb(var(--color-accent))] to-[rgb(var(--color-info))]',
  ...
  },
  {
    ...
    accent: 'from-[rgb(var(--color-success))] to-[rgb(var(--color-event-social))]',
  ...
  },
  {
    ...
    accent: 'from-[rgb(var(--color-cat-technical))] to-violet-500',
  ...
  },
  {
    ...
    accent: 'from-[rgb(var(--color-info))] to-[rgb(var(--color-info))]',
  ...
  },
  {
    ...
    accent: 'from-[rgb(var(--color-warning))] to-[rgb(var(--color-rating-2))]',
  ...
  },
  {
    ...
    accent: 'from-[rgb(var(--color-error))] to-[rgb(var(--color-cat-kpi))]',
