      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/login"
              className="hidden sm:inline-flex items-center gap-2 px-5 py-2 text-xs font-semibold text-[rgb(var(--color-text-inverse))] bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 rounded-lg shadow-sm shadow-indigo-500/20 hover:shadow-md hover:shadow-indigo-500/25 transition-all duration-200"
            >
              Sign in
            </Link>
          ...
          <div id="mobile-menu" className="sm:hidden pb-4 pt-2 border-t border-theme mt-1 space-y-1">
            ...
            <div className="pt-2 mt-2 border-t border-theme">
              <Link
                href="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="block w-full text-center px-4 py-2.5 text-sm font-semibold text-[rgb(var(--color-text-inverse))] bg-gradient-to-r from-indigo-600 to-indigo-500 rounded-lg shadow-sm"
              >
                Sign in
              </Link>
            </div>
