...
export const AuditAction = {
  ...
  LOGIN_INVITATIONS_SENT: 'LOGIN_INVITATIONS_SENT',

  // Goals
  GOAL_CREATED: 'GOAL_CREATED',
  GOAL_SUBMITTED: 'GOAL_SUBMITTED',
  GOAL_APPROVED: 'GOAL_APPROVED',
  GOAL_SELF_APPROVED: 'GOAL_SELF_APPROVED',
  ...
  GOAL_PLACED_ON_HOLD: 'GOAL_PLACED_ON_HOLD',
  ...
  REVIEW_CYCLE_DELETED: 'REVIEW_CYCLE_DELETED',
  ...
  REVIEW_SCHEDULE_COMPLETED: 'REVIEW_SCHEDULE_COMPLETED',
  ...
  VALUE_ACTIVATED: 'VALUE_ACTIVATED',
